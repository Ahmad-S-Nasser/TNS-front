  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-[#0f172a]">Audit Logs</h1>
          <p className="text-[15px] text-[#64748b] mt-1">Real-time record of all administrative activities and system events.</p>
        </div>
        ...
        <CardHeader className="p-6 border-b border-[#f1f5f9]">
          <div className="relative max-w-md">
            ...
            <Input 
              ...
              className="pl-10 h-10 bg-[#f8fafc] border-[#e2e8f0] focus-visible:ring-[#0d9488]/20 focus-visible:border-[#0d9488]" 
              value={search} 
          ...
          <div className="divide-y divide-[#f1f5f9]">
            {filtered.length > 0 ? (
              ...
              <div className="p-12 text-center">
                ...
                <p className="text-slate-500">We couldn't find any logs matching your search criteria.</p>
              </div>
            )}
          </div>
        </CardContent>
      ...
      <div className="flex items-center justify-between pt-2">
        <p className="text-sm text-slate-500">Showing {filtered.length} of {logs.length} activities</p>
        <div className="flex items-center gap-2">
          <Button variant="outline" size="sm" disabled className="h-8 border-[#e2e8f0]">Previous</Button>
          <Button variant="outline" size="sm" className="h-8 border-[#e2e8f0]">Next</Button>
        </div>
      </div>
    </div>
  );
